<?php
     ...
     if(isset($_REQUEST['did']) && $_REQUEST['did'] != "") {
          $tid = base64_decode($_REQUEST['did']);
          $query = "DELETE FROM ticket_mst WHERE iId='".$tid."'"; 
          mysql_query($query);
          $query = "DELETE FROM tick_ans WHERE iTickId='".$tid."'"; 
          mysql_query($query);
...
<div role="main" id="main" class="container_12 clearfix">
     ...
     <section id="content" class="container_12 clearfix" data-sort=true>
          ...
          <!-- Here goes the content. -->
		<h1 class="grid_12 margin-top no-margin-top-phone">Alle Tickets</h1>
			<div class="grid_12">
				<div class="box">
                         <div class="header">
					...
					<div class="content">
						<div class="tabletools">
							<div class="left">
								<a href="tickets_neu.php"><i class="icon-plus"></i>Neues Ticket</a>
							</div>
							<div class="right"></div>
						</div>
                                      ...
                                      ?>
          								<tr>
          									...
          									<td class="center">
          									      ...
          									      <a href="tickets_neu.php?tid=<?=$data[$i]['iId']?>"><span class="icon"><img src="img/icons/packs/fugue/16x16/pencil.png" alt="Ticket bearbeiten" title="Ticket bearbeiten" height=16 width=16></span></a>&nbsp;
          									      <a href="tickets_alle.php?did=<?=base64_encode($data[$i]['iId'])?>"><span class="icon"><img src="img/icons/packs/fugue/16x16/cross-circle-frame.png" alt="Ticket l&ouml;schen" title="Ticket l&ouml;schen" height=16 width=16></span></a>&nbsp;
          									</td>
          								</tr>
					             <?php
                                             }
