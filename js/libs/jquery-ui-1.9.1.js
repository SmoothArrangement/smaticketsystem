...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		prevText: 'Zuruck', // Display text for previous month link
		nextText: 'nachste', // Display text for next month link
		...
		monthNamesShort: ['Jan', 'februar', 'Mar', 'Apr', 'Mai', 'Juni', 'Juli', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], // For formatting
		dayNames: ['Sonntag', 'Montag', 'Dienstag', 'Mittwoch', 'Donnerstag', 'Freitag', 'Samstag'], // For formatting
		dayNamesShort: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'], // For formatting
		dayNamesMin: ['S0','Mo','Di','Mi','Do','Fr','Sa'], // Column headings for days starting at Sunday
...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var controls = (!inst.inline ? '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">Fertig</button>' : '');
