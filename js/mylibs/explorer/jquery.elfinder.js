	...
	this.not('.elfinder-toolbar').each(function() {
		...
		while (l--) {
			if (panels[l]) {
				...
				// EDITED! children(':not(:last),:not(:first):not(:last)') was buggy
				panel.children().not(':last').after('<span class="ui-widget-content elfinder-toolbar-button-separator"/>');
				panel.children().not(':first').not(':last').after('<span class="ui-widget-content elfinder-toolbar-button-separator"/>');
